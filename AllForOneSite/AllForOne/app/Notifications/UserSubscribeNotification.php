...
class UserSubscribeNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->line('Hi ' . $notifiable->name . ' You have subscribed to the event' . $this->event->naam . ' with success')
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'message' => 'You have subscribed to the event ' . $this->event->naam . ' with success',
        ];
    }
}
