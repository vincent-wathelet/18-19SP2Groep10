                ...
                <div class="profile-holder">
                    ...
                    <form class="form-horizontal profile-update" method="POST" action="{{ route('profile') }}">
                        ...
                        <div class="form-group clearfix {{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-12 " >
                            <input type="email" class="form-control" id="email" name="email" value="{{$users['email']}}" placeholder="Enter email to update it">
                            @if ($errors->has('email'))
                                <span class="help-block">
                        ...
                        <input type="password" class="form-control" id="password" name="password" value="" placeholder="Enter password to update it">
                        ...
                        <div class="col-sm-12">
                            <input type="password" class="form-control" id="password_confirmation" value="" name="password_confirmation" placeholder="Re-enter password to confirm">
                        </div>
                        </div>
